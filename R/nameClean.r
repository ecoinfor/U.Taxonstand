#'Format the taxon names of the backbone data into the required format
#'
...
#'datClean <- nameClean(dat) # For the backbone data you will use in the future, you can save the result to save a bit time in the name matching
#'head(datClean)
#'
#'@export
nameClean <- function(dataSource=NULL, author=TRUE){
  ## Add one new column "NameClean" for the data source used to match with. I suggest you to save the result as a R datafile. Then, you can use it directly for further name matching. It will save some time to prepare the data.
